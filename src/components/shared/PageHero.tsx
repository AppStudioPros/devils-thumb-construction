...
export default function PageHero({ title, bgImage }: PageHeroProps) {
  return (
    <section className="relative min-h-[40vh] flex items-end">
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-10 sm:pt-32 sm:pb-14 lg:pb-16">
        <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold text-white font-[Montserrat] leading-tight">
          {title}
        </h1>
      </div>
    </section>
